...
const char* ssid = "AntiGORILAS";//put your wifi ssid here
const char* password = "entreri0s*4*3*6*1";//put your wifi password here.
const char* mqtt_server = "testmqtt.iotcloud.studio";
